...
**PRO Plugin URL: <a href="http://wptreasure.com/responsive-full-width-background-slider-pro/
" target="_blank">Responsive Full Width Background Slider PRO Plugin Url</a>**
...
* Muiltiple Instances of Slider with unlimited slides
* Import/Export slider settings
* Social sharing to share page/post
* Uplaod your own custom overlay
...
* Option for specifying a control bar background & font color with all controls are manaegable
...
* Set social icons background color and font color by your choise
...
* 3 different bullets design to set that is squar/circle/numbered
* Option to manage slide duration & transition speed of slider
* Option to enable/disable slides thumnail
...
* Show images thumbnail on signle click on frontend
